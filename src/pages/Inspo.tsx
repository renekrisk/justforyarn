...
const Inspo: React.FC = () => {
  return (
    <div className="pg-inspo">
      ...
      {/* ── INTRO ────────────────────────────────────────────── */}
      <section className="pg-section" style={{ paddingBottom: '32px' }}>
        <div className="pg-container">
          <div style={{ maxWidth: '680px', margin: '0 auto', textAlign: 'center' }}>
            <p className="lv-kicker" style={{ marginBottom: '16px' }}>Inspiration Board</p>
            <h1 className="lv-heading-md" style={{ marginBottom: '20px' }}>
              See Something You Love?<br />
              <em>Let’s make it yours.</em>
            </h1>
            <p className="lv-body-text">
              Browse our curated inspiration board. Each piece is a starting point — a silhouette, a color palette, or a stitch pattern. 
              Select any piece to initiate a direct bespoke request with Fiona.
            </p>
          </div>
        </div>
      </section>

      {/* ── INSPO MASONRY GRID — PERFECTLY ORGANIZED UNIFORM CARDS ─ */}
      <section className="pg-section" style={{ paddingTop: '20px', paddingBottom: '100px' }}>
        <div className="pg-container">
          <div className="inspo-masonry">
            {inspoItems.map((item) => (
              <div key={item.id} className="inspo-card">
                <div className="inspo-card__media" style={{ aspectRatio: '3/4', position: 'relative' }}>
                  <img
                    src={item.img}
                    alt={item.title}
                  ...
                  <div className="inspo-card__overlay">
                    ...
                    <a
                      ...
                      style={{ width: '100%', textAlign: 'center', marginTop: '16px', color: '#fff', borderColor: 'rgba(255,255,255,0.6)' }}
                    >
                      Request This Piece
                    </a>
                  </div>
      ...
      <section className="lv-manifesto">
        <div className="lv-manifesto__inner">
          ...
          <p className="lv-body-text" style={{ color: 'rgba(255,255,255,0.7)', maxWidth: '480px', margin: '0 auto 32px' }}>
            Don't see exactly what you're looking for? Share a reference image, a Pinterest board, or just describe your vision.
          </p>
          <a
            href={WHATSAPP_BASE}
            target="_blank"
